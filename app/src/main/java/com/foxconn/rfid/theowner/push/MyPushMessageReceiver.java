...
//        }
    	...
    	if(isAppRunning)
    	{
    	 ...
    	 BaiduPushUtils.actionType=3;
    	 BaiduPushUtils.baiduPushTitle=title;
         BaiduPushUtils.baiduPushContent=description;


             Intent intent = new Intent();
             intent.setClass(context.getApplicationContext(), ReadCardMessageActivity.class);
...
//    	List<RunningTaskInfo> list = am.getRunningTasks(100);
//    	boolean isAppRunning = false;
//    	String MY_PKG_NAME = "com.zongshen.byq";
//    	for (RunningTaskInfo info : list) {
//        	if (info.topActivity.getPackageName().equals(MY_PKG_NAME) || info.baseActivity.getPackageName().equals(MY_PKG_NAME)) {
//        		isAppRunning = true;
//        	break;
