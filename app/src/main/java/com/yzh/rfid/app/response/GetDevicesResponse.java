...
public final class GetDevicesResponse {
  ...
  public interface GetDevicesResponseMessageOrBuilder extends
     ...
     */
    java.util.List<Device.DeviceMessage>
        getDeviceList();
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    Device.DeviceMessage getDevice(int index);
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    int getDeviceCount();
     ...
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    java.util.List<? extends Device.DeviceMessageOrBuilder>
        getDeviceOrBuilderList();
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    Device.DeviceMessageOrBuilder getDeviceOrBuilder(
            int index);
  }
  /**
  ...
  public  static final class GetDevicesResponseMessage extends
          ...
          switch (tag) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                device_ = new java.util.ArrayList<Device.DeviceMessage>();
                mutable_bitField0_ |= 0x00000002;
              }
              device_.add(
                  input.readMessage(Device.DeviceMessage.parser(), extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return GetDevicesResponse.internal_static_GetDevicesResponseMessage_descriptor;
    }

    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GetDevicesResponse.internal_static_GetDevicesResponseMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GetDevicesResponseMessage.class, Builder.class);
    }
    ...
    private java.util.List<Device.DeviceMessage> device_;
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    public java.util.List<Device.DeviceMessage> getDeviceList() {
      return device_;
    }
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    public java.util.List<? extends Device.DeviceMessageOrBuilder>
        getDeviceOrBuilderList() {
      return device_;
    }
    /**
     ...
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    public Device.DeviceMessage getDevice(int index) {
      return device_.get(index);
    }
    /**
     * <code>repeated .DeviceMessage device = 2;</code>
     */
    public Device.DeviceMessageOrBuilder getDeviceOrBuilder(
        int index) {
      return device_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof GetDevicesResponseMessage)) {
        return super.equals(obj);
      }
      GetDevicesResponseMessage other = (GetDevicesResponseMessage) obj;
    ...
    public static GetDevicesResponseMessage parseFrom(
    ...
    public static GetDevicesResponseMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GetDevicesResponseMessage parseFrom(
    ...
    public static GetDevicesResponseMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static GetDevicesResponseMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GetDevicesResponseMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(GetDevicesResponseMessage prototype) {
    ...
    public static final class Builder extends
      ...
      public GetDevicesResponseMessage getDefaultInstanceForType() {
        return GetDevicesResponseMessage.getDefaultInstance();
      }

      public GetDevicesResponseMessage build() {
        GetDevicesResponseMessage result = buildPartial();
      ...
      public GetDevicesResponseMessage buildPartial() {
        GetDevicesResponseMessage result = new GetDevicesResponseMessage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GetDevicesResponseMessage) {
          return mergeFrom((GetDevicesResponseMessage)other);
        } else {
      ...
      public Builder mergeFrom(GetDevicesResponseMessage other) {
        if (other == GetDevicesResponseMessage.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        GetDevicesResponseMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (GetDevicesResponseMessage) e.getUnfinishedMessage();
      ...
      private void ensureDeviceIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          device_ = new java.util.ArrayList<Device.DeviceMessage>(device_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          Device.DeviceMessage, Device.DeviceMessage.Builder, Device.DeviceMessageOrBuilder> deviceBuilder_;
      ...
      public Builder setDevice(
          int index, Device.DeviceMessage value) {
        if (deviceBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setDevice(
          int index, Device.DeviceMessage.Builder builderForValue) {
        if (deviceBuilder_ == null) {
          ensureDeviceIsMutable();
       ...
       * <code>repeated .DeviceMessage device = 2;</code>
       */
      public Builder addDevice(Device.DeviceMessage value) {
        if (deviceBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addDevice(
          Device.DeviceMessage.Builder builderForValue) {
        if (deviceBuilder_ == null) {
          ensureDeviceIsMutable();
      ...
      public Builder addAllDevice(
          Iterable<? extends Device.DeviceMessage> values) {
        if (deviceBuilder_ == null) {
          ensureDeviceIsMutable();
       ...
       * <code>repeated .DeviceMessage device = 2;</code>
       */
      public Device.DeviceMessage.Builder getDeviceBuilder(
          int index) {
       ...
       * <code>repeated .DeviceMessage device = 2;</code>
       */
      public Device.DeviceMessage.Builder addDeviceBuilder() {
        return getDeviceFieldBuilder().addBuilder(
            Device.DeviceMessage.getDefaultInstance());
      }
      /**
       * <code>repeated .DeviceMessage device = 2;</code>
       */
      public Device.DeviceMessage.Builder addDeviceBuilder(
          int index) {
        return getDeviceFieldBuilder().addBuilder(
            index, Device.DeviceMessage.getDefaultInstance());
      }
      /**
       * <code>repeated .DeviceMessage device = 2;</code>
       */
      public java.util.List<Device.DeviceMessage.Builder>
           getDeviceBuilderList() {
        return getDeviceFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          Device.DeviceMessage, Device.DeviceMessage.Builder, Device.DeviceMessageOrBuilder>
          getDeviceFieldBuilder() {
        if (deviceBuilder_ == null) {
    ...
    private static final GetDevicesResponseMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new GetDevicesResponseMessage();
    }

    public static GetDevicesResponseMessage getDefaultInstance() {
